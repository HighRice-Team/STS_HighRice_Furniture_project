...
<body>
	<div style="margin: 0 15% 0 15%; padding: 40px 0 40px 0;">
		<h2>JOIN</h2>
		<hr>
		<form action="joinCheck.do" name="form" method="get">
			<table width="100%" height="650">
				<tr>
					<td width="100%" height="50%" align="center">
						<p align="left"><span style="padding-left: 160px">BIT가구대여 약관동의</span></p><br>
...
- 생성정보 수집 툴을 통한 수집
   						...
   						<input type="checkbox" name="chk1"> 개인정보 수집 및 이용에 동의합니다.
					</td>
				</tr>
				<tr>
					<td width="100%" height="50%" align="center">
...
- 생성정보 수집 툴을 통한 수집
   						...
   						<input type="checkbox" name="chk2"> 개인정보 수집 및 이용에 동의합니다.
					</td>
				</tr>
				<tr>
